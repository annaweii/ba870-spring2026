...
st.markdown(
    """
<div style="background: linear-gradient(135deg, #020617 0%, #1e3a8a 55%, #4f46e5 100%); padding: 3.2rem 3rem 2.6rem 3rem; border-radius: 24px; margin-bottom: 2.2rem; box-shadow: 0 18px 45px rgba(15, 23, 42, 0.20); border: 1px solid rgba(255,255,255,0.08);">
    <div style="font-size: 3rem; font-weight: 900; color: white; margin-bottom: 0.5rem; letter-spacing: -0.5px;">
        RiskMonitor
    </div>
    <div style="font-size: 1.15rem; color: #c7d2fe; max-width: 750px; line-height: 1.6; margin-bottom: 1.6rem;">
    ...
    <div style="display: flex; gap: 0.7rem; flex-wrap: wrap;">
        <div style="background: rgba(255,255,255,0.12); padding: 0.5rem 0.9rem; border-radius: 999px; color: white; font-size: 0.8rem; font-weight: 600;">
            Machine Learning
        </div>
        <div style="background: rgba(255,255,255,0.12); padding: 0.5rem 0.9rem; border-radius: 999px; color: white; font-size: 0.8rem; font-weight: 600;">
            Real-Time Data
