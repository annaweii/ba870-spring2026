...
with c1:
    ...
    <div class="step-box">
        ...
        <div class="step-text">Open the Company Risk Check page and enter a public stock ticker</div>
    </div>
    """, unsafe_allow_html=True)
with c2:
    st.markdown("""
...
with c3:
    ...
    <div class="step-box">
        ...
        <div class="step-text">Use the Financial Health Dashboard and Model Insights pages for deeper analysis</div>
    </div>
    """, unsafe_allow_html=True)
